    ...
    async with httpx.AsyncClient(trust_env=False) as client:
        async with asyncio.timeout(300):
            report, status = await research(
                ResearchInput(
                    idea="Investigate a compact coffee grinder with replaceable burrs. This is a test using synthetic evidence."
                ),
        ...
        json.dumps(
            {
                ...
                "evidence": "synthetic test fixture; real local model",
            }
        )
    )
