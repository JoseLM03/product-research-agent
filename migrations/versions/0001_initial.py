...
def upgrade():
    op.create_table(
        ...
        sa.Column("idea", sa.String(500), nullable=False),
    ...
    for field in ("owner", "status", "created_at"):
    ...
    for field in ("owner", "ip_hash", "created_at"):
        op.create_index(f"ix_admissions_{field}", "admissions", [field])
    op.create_table(
        "admission_lock",
